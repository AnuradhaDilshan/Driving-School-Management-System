...
const MyJourney = () => {
  ...
  const [nicSelectedFile, setNicSelectedFile] = useState(null);
  ...
  const [medicalCertificateSelectedFile, setMedicalCertificateSelectedFile] =
    useState(null);
  const [idPhotoSelectedFile, setidPhotoSelectedFile] = useState(null);
  ...
  const handleSubmission = async (e) => {
    ...
    try {
      ...
      formData.append("nic", auth?.user?.nic);
      formData.append("category", Category);
      formData.append("selectedOptions", JSON.stringify(selectedOptions));
      formData.append("practice", Practice);
      formData.append("totalPrice", calculateTotalPrice());
      formData.append("nicImage", nicSelectedFile);
      formData.append("birthImage", birthCertificateSelectedFile);
      formData.append("photoImage", idPhotoSelectedFile);
      formData.append("medicalImage", medicalCertificateSelectedFile);
      const res = await axios.post("/api/v1/submission/submitting", formData, {
        headers: {
      ...
      if (res && res.data.success) {
        ...
        setCategory("Light-Weight Vehicle");
        setSelectedOptions([]);
        setPractice("With Practice");
      ...
      console.log(error);
      toast.error("Need to Upload Documents");
    }
  };
  ...
  return (
    <Layout title={"Savingo Driving School | MyJourney"}>
                ...
                >
                  ...
                  <div className="channel">
                    ...
                    <a
                      ...
                      href="https://echannelling.com/ntmi-channel-driving-license-medical"
                      target="_blank"
                    >
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-3">
                        <div className="upload">
                          ...
                          <form
                            id="uploadFormBirthCertificate"
                            encType="multipart/form-data"
                          >
                            <label
                              htmlFor="fileInputBirthCertificate"
                              className="custom-file-upload"
                            >
                              <input
                                type="file"
                                ...
                                accept=".jpg, .jpeg, .png, .pdf"
                                onChange={(e) =>
                                  handleFileInputChange(e, "birthCertificate")
                                }
                                style={{ display: "none" }}
                                ref={fileInputRefBirthCertificate}
                              />
                              Upload
                            </label>
                          </form>
                      ...
                      <div className="col-md-3">
                        <div className="upload">
                          ...
                          <form
                            id="uploadFormIdPhoto"
                            encType="multipart/form-data"
                          >
                            <label
                              htmlFor="fileInputIdPhoto"
                              className="custom-file-upload"
                            >
                              <input
                                type="file"
                                ...
                                accept=".jpg, .jpeg, .png, .pdf"
                                onChange={(e) =>
                                  handleFileInputChange(e, "idPhoto")
                                }
                                style={{ display: "none" }}
                                ref={fileInputRefIdPhoto}
                              />
                              Upload
                            </label>
                          </form>
                      ...
                      <div className="col-md-3">
                        <div className="upload">
                          ...
                          <form
                            id="uploadFormMedicalCertificate"
                            encType="multipart/form-data"
                          >
                            <label
                              htmlFor="fileInputMedicalCertificate"
                              className="custom-file-upload"
                            >
                              <input
                                type="file"
                                ...
                                accept=".jpg, .jpeg, .png, .pdf"
                                onChange={(e) =>
                                  handleFileInputChange(e, "medicalCertificate")
                                }
                                style={{ display: "none" }}
                                ref={fileInputRefMedicalCertificate}
                              />
                              Upload
                            </label>
                          </form>
